...
const struct pcl_pad_control evt1_full_pad[] = {
	/* PCL_I2C0_SCL */
	{ 0, // GPIO_0
	...
	{ 1, // GPIO_1
		PCL_MODE_IS_0 | PCL_MODE_OS_0 | PCL_ID_EN | PCL_FBD_ON | PCL_PS_INTERNAL_SIG
		 | PCL_DP_IN | PCL_OD | PCL_ENAQ_EN | PCL_DRV_7 | PCL_SLOW
	},
	/* PCL_I2C1_SCL */
	{ 2, // GPIO_2
		PCL_MODE_OS_0 | PCL_ID_EN | PCL_FBD_ON | PCL_PS_INTERNAL_SIG | PCL_DP_OUT | PCL_OD
	...
	/* PCL_POWER_INTERRUPT_ICCMAX_VDDD */
	{ 56, // GPIO_56
...
const struct pcl_pad_control evt1_prime_pad[] = {
	/* PCL_I2C0_SCL */
	{ 0, // GPIO_0
		PCL_MODE_OS_0 | PCL_ID_EN | PCL_FBD_ON | PCL_PS_INTERNAL_SIG | PCL_DP_OUT | PCL_OD
		 | PCL_ENAQ_EN | PCL_DRV_7 | PCL_SLOW
	...
	/* PCL_GPIO_EXP_INT_N */
	{ 8, // GPIO_8
		PCL_MODE_IS_4 | PCL_ID_EN | PCL_FBD_ON | PCL_DP_IN | PCL_ENAQ_EN
	},
	/* PCL_UART0_SOUT */
	{ 10, // GPIO_10
		PCL_MODE_OS_0 | PCL_ID_EN | PCL_PS_INTERNAL_SIG | PCL_DP_OUT | PCL_PP | PCL_ENAQ_EN
